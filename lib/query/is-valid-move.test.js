...
describe('is-valid-move', function() {
    ...
    it('does not allow pawns to jump over both friendly and enemy pieces in the same jump', function() {
        var game = createEmptyGame(),
            withPawnInJumpRange = updateBoardSpace(game, 8, 5, {piece: constants.PAWN, color: constants.WHITE});
    ...
    it('does allow knights to jump over both friendly and enemy pieces in the same jump', function() {
        var game = createEmptyGame(),
            withPawnInJumpRange = updateBoardSpace(game, 4, 10, {piece: constants.PAWN, color: constants.BLACK});
    ...
    it('does not allow white to move into its own goal', function() {
        var game = createEmptyGame(),
            withPawnNearGoal = updateBoardSpace(game, 1, 5, {piece: constants.PAWN, color: constants.WHITE});
    ...
    it("does allow black to move into white's goal", function() {
        var game = createEmptyGame(),
            withPawnNearGoal = updateBoardSpace(game, 1, 5, {piece: constants.PAWN, color: constants.BLACK});
    ...
    it("does allow white to move into black's goal", function() {
        var game = createEmptyGame(),
            withPawnNearGoal = updateBoardSpace(game, 15, 5, {piece: constants.PAWN, color: constants.WHITE});
    ...
    it('does not allow black to move into its own goal', function() {
        var game = createEmptyGame(),
            withPawnNearGoal = updateBoardSpace(game, 15, 5, {piece: constants.PAWN, color: constants.BLACK});
