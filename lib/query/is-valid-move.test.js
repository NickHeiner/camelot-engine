...
describe('is-valid-move', function() {
    ...
    it('does not allow pawns to jump over both friendly and enemy pieces in the same jump', function() {
        var game = createEmptyGame(),
            withPawnInJumpRange = updateBoardSpace(game, 8, 5, {piece: constants.PAWN, player: 'playerA'});
    ...
    it('does allow knights to jump over both friendly and enemy pieces in the same jump', function() {
        var game = createEmptyGame(),
            withPawnInJumpRange = updateBoardSpace(game, 4, 10, {piece: constants.PAWN, player: 'playerB'});
    ...
    it('does not allow playerA to move into its own goal', function() {
        var game = createEmptyGame(),
            withPawnNearGoal = updateBoardSpace(game, 1, 5, {piece: constants.PAWN, player: 'playerA'});
    ...
    it("does allow playerB to move into playerA's goal", function() {
        var game = createEmptyGame(),
            withPawnNearGoal = updateBoardSpace(game, 1, 5, {piece: constants.PAWN, player: 'playerB'});
    ...
    it("does allow playerA to move into playerB's goal", function() {
        var game = createEmptyGame(),
            withPawnNearGoal = updateBoardSpace(game, 15, 5, {piece: constants.PAWN, player: 'playerA'});
    ...
    it('does not allow playerB to move into its own goal', function() {
        var game = createEmptyGame(),
            withPawnNearGoal = updateBoardSpace(game, 15, 5, {piece: constants.PAWN, player: 'playerB'});
