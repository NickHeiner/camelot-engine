...
describe('is-valid-move', function() {
    ...
    it('does not allow a non-jump followed by a jump', function() {
        var game = createEmptyGame(),
            withPieceToJump = updateBoardSpace(game, 3, 6, {piece: {type: constants.PAWN, player: 'playerB'}});

        expect(isValidMove(withPieceToJump, [
            {
                row: 5,
                col: 6
            },
